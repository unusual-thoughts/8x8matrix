...
/* If you use a LED matrix, set the number of rows here. Otherwise set it to 1*/
#define NUM_ROWS                8
...
#if NUM_ROWS != 1
# include "pinouts/matrix_includes.h"
# define A0_PIN                  DEFAULT_A0_PIN
# define A0_PORT                 DEFAULT_A0_PORT
# define A0_DDR                  DEFAULT_A0_DDR

# define A1_PIN                  DEFAULT_A1_PIN
# define A1_PORT                 DEFAULT_A1_PORT
# define A1_DDR                  DEFAULT_A1_DDR

# define A2_PIN                  DEFAULT_A2_PIN
# define A2_PORT                 DEFAULT_A2_PORT
# define A2_DDR                  DEFAULT_A2_DDR
#endif
...
#if NUM_ROWS != 1
//# define ROW_MASK (~(1 << A0_PIN) | (1 << A1_PIN) | (1 << A2_PIN))
# define ROW_MASK (0xFF && ~(1 << A0_PIN) && ~(1 << A1_PIN) && ~(1 << A2_PIN))
//# define ROW_MASK 31
#endif
